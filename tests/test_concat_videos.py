...
def test_concat_set_writes_canonical_section_types_in_metadata_order(
    ...
    out_tiff = tmp_path / "2-1_concat.tiff"
    out_csv = tmp_path / "2-1_concat_order.csv"
    concat_videos.concat_set(set_dict, out_tiff, out_csv)
...
def test_dry_run_prints_metadata_order_details(tmp_path: Path, capsys: pytest.CaptureFixture[str]):
    ...
    concat_videos.dry_run_set(set_dict, tmp_path / "out.tiff", tmp_path / "out.csv")
